...
def check_support_available(support_id) -> Optional[int]:
...
def get_support_manager() -> Optional[int]:
...
def support_keyboard(messages, user_id=None) -> Union[bool, InlineKeyboardMarkup]:
    if user_id:
