...
def create_moderate_ik(telegram_id) -> InlineKeyboardMarkup:
    markup = InlineKeyboardMarkup()
    accept = InlineKeyboardButton(_("✅ Одобрить"), callback_data=f"moderate_accept-{telegram_id}")
    reject = InlineKeyboardButton(_("❌ Отклонить"), callback_data=f"moderate_decline-{telegram_id}")
...
def view_event_keyboard(telegram_id) -> InlineKeyboardMarkup:
    markup = InlineKeyboardMarkup()
    meet = InlineKeyboardButton(_("Пойду!"), callback_data=f"answer_imgoing-{telegram_id}")
    not_interested = InlineKeyboardButton(_("Не интересно"), callback_data=f"answer_notinteresting-{telegram_id}")
...
def cancel_event_keyboard(telegram_id) -> InlineKeyboardMarkup:
    markup = InlineKeyboardMarkup()
    backed_out = InlineKeyboardButton(_("❌ Отменить запись"), callback_data=f"cancel-{telegram_id}")
